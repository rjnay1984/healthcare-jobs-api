...
namespace HealthcareJobs.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250930220045_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HealthcareJobs.Core.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("HealthcareJobs.Core.Entities.Candidate", b =>
                {
                    b.HasOne("HealthcareJobs.Core.Entities.User", "User")
                        .WithOne()
                        .HasForeignKey("HealthcareJobs.Core.Entities.Candidate", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HealthcareJobs.Core.Entities.Employer", b =>
                {
                    ...
                    b.HasOne("HealthcareJobs.Core.Entities.User", "User")
                        .WithOne()
                        .HasForeignKey("HealthcareJobs.Core.Entities.Employer", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
